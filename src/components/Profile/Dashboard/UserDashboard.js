        ...
        <div className="dropdown">
          ...
          {showMenu && (
            <div className="sidebar">
              <NavLink exact to="/token-list" activeClassName="active" className="nav-link">
                <FaWallet className="nav-icon" /> Wallet
              </NavLink>
              <NavLink exact to="/my-tokens" activeClassName="active" className="nav-link">
                <FaFolder className="nav-icon" /> My NFTs
              </NavLink>
              <NavLink exact to="/profile-settings" activeClassName="active" className="nav-link">
                <FaCog className="nav-icon" /> Profile Settings
              </NavLink>
              <NavLink exact to="/create-collection" activeClassName="active" className="nav-link">
                <FaPlus className="nav-icon" /> Create Collection
              </NavLink>
              <NavLink exact to="/my-collections" activeClassName="active" className="nav-link">
                <FaBox className="nav-icon" /> My Collections
              </NavLink>
              <NavLink exact to="/my-auctions" activeClassName="active" className="nav-link">
