...
import StripePayment from '../../components/Pworld/stripe.js'; // Adjust the path
...
const contractAddress = process.env.REACT_APP_PWOLRD_ADDRESS;
const maxSupply = 486;
...
const stripePromise = loadStripe('pk_test_51NfKIbC4V91YyiYlLJnpFYH82QhNVmgIHS05cHOcWP784e2Y9AjSoP4mxth3fOhrH0RJiqBnckFIJg9bGlmGc0oq00hL62kpiN'); // Load Stripe
  ...
  return (
    ...
    <div className="punk-world-container">
      ...
      {isLoading ? <p>Loading...</p> : (
        ...
        {paymentSuccess ? (
          <div className="success-message">Payment successful! Minting NFT...</div>
        ) : (
          <StripePayment
            fees={fees}
