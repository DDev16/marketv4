...
const [showExtraNFTAlert, setShowExtraNFTAlert] = useState(false);
  ...
  const paypalOptions = {
    "client-id": "ATkYBlbsl9tp2kTcHKRHd_V-0Wr-vEZYwPiiVurEbd3f4kCjAVcHY59Valjv0vAYD-p76t2uVVY02-dF",
    currency: "USD",
    intent: "capture",
  ...
  const onApprove = async (data, actions) => {
    ...
    // Mint NFT or perform other actions here
    handleMint();
  };
  ...
  return (
    <PayPalScriptProvider options={{ "client-id": "ATkYBlbsl9tp2kTcHKRHd_V-0Wr-vEZYwPiiVurEbd3f4kCjAVcHY59Valjv0vAYD-p76t2uVVY02-dF" }}>
