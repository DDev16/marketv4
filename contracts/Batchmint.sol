...
contract MyNFTmint is ERC721, Ownable, ReentrancyGuard, IERC2981 {
    ...
    function mint(
        ...
        require(royaltyPercentage <= 100, "Royalty can't be more than 100%.");
   ...
   function batchMint(
    ...
    require(
        names.length == descriptions.length &&
            ...
            names.length == royaltyPercentages.length,
        ...
        returns (address receiver, uint256 royaltyAmount) 
    {
        ...
        uint256 royaltyPercentage = _royalties[tokenId];
